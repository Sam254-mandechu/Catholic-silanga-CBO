      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-6 italic">
            "Dear brothers and sisters, welcome to our community. Whether you are a long-time
            member, a first-time visitor, or simply searching for a place to belong — know that
            you are loved by God and embraced by our parish family. Together, we walk in faith,
            serve in love, and grow in hope."
          </p>
